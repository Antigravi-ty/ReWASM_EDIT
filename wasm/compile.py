...
exported_functions = (
    ...
    "'_physics_saveState','_physics_restoreState','_physics_saveStateSlot',"
    "'_physics_restoreStateSlot','_physics_getStateSnapshotSize','_physics_stepSilent',"
    "'_physics_initBallPrediction','_physics_updateBallPrediction','_physics_getBallPredictionPtr',"
