...
function assignWasmExports(wasmExports) {
  ...
  _physics_init = Module["_physics_init"] = wasmExports["o"];
  _physics_createArena = Module["_physics_createArena"] = wasmExports["p"];
  _physics_step = Module["_physics_step"] = wasmExports["q"];
  _physics_stepSilent = Module["_physics_stepSilent"] = wasmExports["r"];
  _physics_saveState = Module["_physics_saveState"] = wasmExports["s"];
  _physics_restoreState = Module["_physics_restoreState"] = wasmExports["t"];
  _physics_saveStateSlot = Module["_physics_saveStateSlot"] = wasmExports["u"];
  _physics_restoreStateSlot = Module["_physics_restoreStateSlot"] = wasmExports["v"];
  _physics_getStateSnapshotSize = Module["_physics_getStateSnapshotSize"] = wasmExports["w"];
  _physics_resetKickoff = Module["_physics_resetKickoff"] = wasmExports["x"];
  _physics_setImpactThresholds = Module["_physics_setImpactThresholds"] = wasmExports["y"];
  _physics_setSurfaceTaxonomyThresholds = Module["_physics_setSurfaceTaxonomyThresholds"] = wasmExports["z"];
  _physics_setDirectionDotThreshold = Module["_physics_setDirectionDotThreshold"] = wasmExports["A"];
  _physics_getDirectionDotThreshold = Module["_physics_getDirectionDotThreshold"] = wasmExports["B"];
  _physics_updateBallPrediction = Module["_physics_updateBallPrediction"] = wasmExports["C"];
  _physics_getBallPredictionPtr = Module["_physics_getBallPredictionPtr"] = wasmExports["D"];
  _physics_getBallPredictionCount = Module["_physics_getBallPredictionCount"] = wasmExports["E"];
  _physics_isBallSleeping = Module["_physics_isBallSleeping"] = wasmExports["F"];
  _physics_setSimulationFrozen = Module["_physics_setSimulationFrozen"] = wasmExports["G"];
  _physics_setPossessionReportingEnabled = Module["_physics_setPossessionReportingEnabled"] = wasmExports["H"];
  _physics_getPossessionStats = Module["_physics_getPossessionStats"] = wasmExports["I"];
  _physics_pushSignalEvent = Module["_physics_pushSignalEvent"] = wasmExports["J"];
  _physics_initReplayBuffer = Module["_physics_initReplayBuffer"] = wasmExports["K"];
  _malloc = Module["_malloc"] = wasmExports["L"];
  _physics_clearReplayBuffer = Module["_physics_clearReplayBuffer"] = wasmExports["M"];
  _physics_getReplayBufferPtr = Module["_physics_getReplayBufferPtr"] = wasmExports["N"];
  _physics_getReplayBufferSize = Module["_physics_getReplayBufferSize"] = wasmExports["O"];
  _physics_recordReplayFrame = Module["_physics_recordReplayFrame"] = wasmExports["P"];
  _physics_getEventBufferPtr = Module["_physics_getEventBufferPtr"] = wasmExports["Q"];
  _physics_getEventBufferSize = Module["_physics_getEventBufferSize"] = wasmExports["R"];
  _physics_clearEvents = Module["_physics_clearEvents"] = wasmExports["S"];
  _physics_getStatePtr = Module["_physics_getStatePtr"] = wasmExports["T"];
  _physics_getStateSize = Module["_physics_getStateSize"] = wasmExports["U"];
